...
const PrivacyPolicy  = ()=>{
    ...
    privacyPolicyWrapper.innerHTML = ` <div class="modal fade" id="privacyPolicyModal" tabindex="-1" aria-labelledby="privacyPolicyModalLabel" aria-hidden="true">
